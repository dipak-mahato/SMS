...
<div class="row">
   ...
   <div class="col-md-8"><h3 style="background-color: #10d609; text-align: center;">{{$student->name}} Detail</h3>
   	 <table>
   		...
   		<tr><th>Gender  :</th><td style="padding-left: 10px">{{$student->name}}</td></tr>

   		<tr><th>DOB:</th><td style="padding-left: 10px">{{$student->dob}}</td></tr>		   		
   		<tr><th> Parent:</th><td style="padding-left: 10px">{{$student->name}}</td></tr>
   		<tr><th>Contact:</th><td style="padding-left: 10px">{{$student->phone}}</td></tr>
   		<tr><th>Class:</th><td style="padding-left: 10px">{{$student->name}}</td></tr>				
   		<tr><th>Section:</th><td style="padding-left: 10px">{{$student->name}}</td></tr>
   		<tr><th>Shift:</th><td style="padding-left: 10px">{{$student->name}}</td></tr> 	 	
   	 </table>
